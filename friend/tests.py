...
#         self.friendrequest = FriendRequestFactory.create(pk=123)

#         # instantiate serializer objects
#         # self.GroupChatSerializer = GroupChatSerializer(instance=self.groupchat)
#         self.FriendRequestSerializer = FriendRequestSerializer(instance=self.groupchat_message)

#     def tearDown(self):
#         # GroupChatFactory.reset_sequence(0)
#         FriendRequestFactory.reset_sequence(0)

#     # =================== SET OF SERIALIZER TESTS ===========================
#     # =================== comment out when necessary =======================
#     # ======================================================================
#     def test_FriendRequestSerializer(self):
