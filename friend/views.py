...
# change name to friend_request_view
def friend_requests(request, *args, **kwargs):
	...
	if user.is_authenticated:
		...
		# only can view own account's friend requests
		if account == user:
		...
		if user_id:
			...
			try:
				...
				try:
					...
					friend_request.save()
					payload['response'] = "Friend request sent." # can set to CONSTANT
...
def accept_friend_request(request, *args, **kwargs):
	...
	if request.method == "GET" and user.is_authenticated:
		friend_request_id = kwargs.get("friend_request_id") # kwargs from url <friend_request_id>
